export const gameState = {
    ...
    houses: [
        ...
        { name: 'Porto de Fortaleza', type: 'port', price: 5000, icon: '⚓', actions: ['buy'] },
        { name: 'Evento Oceânico', type: 'event', icon: '🌊', actions: [] },
        { name: 'Porto de Santos', type: 'port', price: 7000, icon: '🚢', actions: ['buy'] },
        { name: 'Posto de Combustível', type: 'fuel', price: 3000, icon: '⛽', actions: ['buy'] },
        ...
        { name: 'Porto do Açu', type: 'port', price: 8000, icon: '🛳️', actions: ['buy'] },
        // Corner 18 (TugLord)
        { name: 'Certificação TugLord', type: 'corner', icon: '🎖️', actions: [] },
        // Side 3 (Top) 19-26
        ...
        { name: 'Treinamento', type: 'training', price: 2000, icon: '🎓', actions: ['buy'] },
        { name: 'Porto de Suape', type: 'port', price: 7500, icon: '🚢', actions: ['buy'] },
        // Corner 27 (Bank)
        { name: 'Banco Central', type: 'corner', icon: '🏛️', actions: [] },
        // Side 4 (Right) 28-35
        { name: 'Porto de Manaus', type: 'port', price: 5000, icon: '⛴️', actions: ['buy'] },
        { name: 'Carta Azar', type: 'luck', icon: '⚠️', actions: [] },
        { name: 'Estaleiro Naval', type: 'workshop', price: 5500, icon: '🏗️', actions: ['buy'] },
        { name: 'Porto de Belém', type: 'port', price: 5500, icon: '⛵', actions: ['buy'] },
        { name: 'Evento Oceânico', type: 'event', icon: '🌊', actions: [] },
        { name: 'Porto de São Luís', type: 'port', price: 6000, icon: '🚤', actions: ['buy'] },
        { name: 'Taxa Portuária', type: 'tax', price: 1000, icon: '💸', actions: ['pay'] },
        { name: 'Porto de Vila do Conde', type: 'port', price: 6500, icon: '🚢', actions: ['buy'] }
    ].map((h, i) => ({ ...h, pos: i }))
};
